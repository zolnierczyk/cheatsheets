...
\includegraphics[page = 1, width=\linewidth]{metauml/Singleton-1.pdf}
...
\includegraphics[page = 1, width=\linewidth]{metauml/Flyweight1-1.pdf}
...
\includegraphics[page = 1, width=\linewidth]{metauml/Iterator1-1.pdf}
\subsection{Mediator}
...
\includegraphics[page = 1, width=\linewidth]{metauml/TemplateMethod1-1.pdf}
\subsection{Visitor}
